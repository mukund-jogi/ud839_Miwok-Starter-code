...
public class MainActivity extends AppCompatActivity {
    ...
    public void openFamilyMemberActivity(View view) {
        Intent familyMemberActivityInent = new Intent(this,FamilyMembersActivity.class);
        startActivity(familyMemberActivityInent);
    }
